...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('models/menuGroups.plural')</h1>
                </div>
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="{{ route('menu-groups.create') }}">
                         @lang('crud.add_new') Menu Group
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="content px-3">
        ...
        <div class="card" id="table-container">
            @include('root.menu_groups.table')
        </div>
    </div>
